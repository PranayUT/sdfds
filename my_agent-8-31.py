            ...
            messages = [ # System prompt for navigation
                {
                    ...
                    "content": (
                        ...
                        "- BLUE LINE: Your movement history on the top-down map.\n\n"
                        ...
                        "7. Main objective: Reach the goal by following the SHORTEST possible path (minimize the total blue line length on the top-down map).\n"
                        "8. While moving through hallways, stay centered in the gray area instead of hugging walls for smoother navigation and reduced collision risk.\n\n"
                        "=== DECISION RULES ===\n"
                        ...
                        "- Break the task instruction into sub-goals (e.g., 'walk through hallway' → sub-goal: reach hallway).\n"
                        "- Maintain memory of completed sub-goals and advance to the next.\n"
                        "- Align map reasoning with the sub-goal (if the instruction says 'enter the room on the left,' prioritize detecting a doorway on the left side of the map/camera).\n"
                        ...
                        "=== VISITED-PATH AWARENESS ===\n"
                        "- The BLUE LINE shows where you’ve already been.\n"
                        "- Avoid retracing the blue line unless no other path exists.\n"
                        "- If you notice looping or stalled progress, turn toward unexplored gray areas.\n"
                        "- Revisiting the same spot (same position + orientation) = loop → change strategy immediately.\n\n"
                        "=== OUTPUT FORMAT ===\n"
                        "Action: [0-3]\n"
                        "Current subgoal: [Describe current subgoal from instruction]\n"
